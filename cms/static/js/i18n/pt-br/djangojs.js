...
'use strict';
{
  ...
  const newcatalog = {
    ...
    "%(errorCount)s error found in form.": [
      ...
      "Erros %(errorCount)s encontrados no formul\u00e1rio.",
      "Erros %(errorCount)s encontrados no formul\u00e1rio."
    ],
    ...
    "(contains %(student_count)s student)": [
      "(cont\u00e9m aluno %(student_count)s )",
      "(cont\u00e9m alunos %(student_count)s )",
      "(cont\u00e9m alunos %(student_count)s )"
    ],
    "(optional)": "(opcional)",
    ...
    "Active subscription": "Assinatura ativa",
    "Add": "Adicionar",
    ...
    "Discussion Configuration": "Configura\u00e7\u00e3o de discuss\u00e3o",
    ...
    "Embed your subsection content directly on a page using an iframe, and view it withput the LMS header and footer.": "Incorpore o conte\u00fado da sua subse\u00e7\u00e3o diretamente em uma p\u00e1gina usando um iframe e visualize-o sem o cabe\u00e7alho e rodap\u00e9 do LMS.",
    "Emoticons": "Emoticons",
    "Enable": "Habilitar",
    ...
    "Explore subscription options": "Explore as op\u00e7\u00f5es de assinatura",
    ...
    "Hidden in the course outline, but sections are accessible for your learners through their separate link.": "Oculto no esbo\u00e7o do curso, mas as se\u00e7\u00f5es podem ser acessadas pelos alunos por meio de um link separado.",
    "Hide": "Esconder",
    ...
    "If you had a subscription previously, your payment history is still available on the {a_start}Orders and subscriptions{a_end} page": "Se voc\u00ea j\u00e1 tinha uma assinatura, seu hist\u00f3rico de pagamentos ainda estar\u00e1 dispon\u00edvel na p\u00e1gina {a_start} Pedidos e assinaturas {a_end}",
    ...
    "If you make this section visible in the table of content, learners will be able to see its content.": "Se voc\u00ea tornar esta se\u00e7\u00e3o vis\u00edvel no \u00edndice, os alunos poder\u00e3o ver seu conte\u00fado.",
    ...
    "Inactive subscription": "Assinatura inativa",
    ...
    "It is intentionally hidden from learners, ensuring that only the course staff can view its contents.": "Ele \u00e9 intencionalmente oculto dos alunos, garantindo que apenas a equipe do curso possa visualizar seu conte\u00fado.",
    ...
    "It is visible to learners, ensuring that all learners can view its contents.": "\u00c9 vis\u00edvel para os alunos, garantindo que todos os alunos possam visualizar seu conte\u00fado.",
    "Italic": "It\u00e1lico",
    ...
    "Load next {num_items} result": [
      ...
      "Carregar os pr\u00f3ximos resultados {num_items}",
      "Carregar os pr\u00f3ximos resultados {num_items}"
    ],
    "Loading": "Carregando",
    ...
    "Monthly program subscriptions {emDash} more flexible, more affordable": "Assinaturas mensais do programa {emDash} mais flex\u00edveis e mais acess\u00edveis",
    "More": "Mais",
    ...
    "Need help? Check out the {a_start}Learner Help Center{span_start}{icon}{span_end}{a_end} to troubleshoot issues or contact support": "Preciso de ajuda? Confira a Central de Ajuda estudante {a_start} {span_start} {icon} {span_end} {a_end} para solucionar problemas ou entrar em contato com o suporte",
    ...
    "November": "Novembro",
    "Now": "Agora",
    "Now available for many popular programs, affordable monthly subscription pricing can help you manage your budget more effectively. Subscriptions start at {minSubscriptionPrice}/month USD per program, after a 7-day full access free trial. Cancel at any time.": "Agora dispon\u00edvel para muitos programas populares, o pre\u00e7o acess\u00edvel da assinatura mensal pode ajud\u00e1-lo a gerenciar seu or\u00e7amento com mais efici\u00eancia. As assinaturas come\u00e7am em {minSubscriptionPrice} / m\u00eas USD por programa, ap\u00f3s um teste gratuito completo de 7 dias Acesso . cancelar a qualquer momento.",
    ...
    "Pause": "Pausar",
    "Pay {subscriptionPrice} after {trialLength}-day free trial": "Pague {subscriptionPrice} ap\u00f3s {trialLength} -dia de teste gratuito",
    "Pay {subscriptionPrice} for all courses in this program": "Pague {subscriptionPrice} por todos os cursos deste programa",
    "Photo": "Foto",
    ...
    "Please enable discussions for graded units from the": "Por favor, ative discuss\u00f5es para unidades avaliadas do",
    ...
    "Restart my subscription": "Reiniciar minha assinatura",
    "Restart your subscription for {subscriptionPrice}. Your payment history is still available on the {a_start}Orders and subscriptions{a_end} page": "Reinicie sua assinatura para {subscriptionPrice} . Seu hist\u00f3rico de pagamentos ainda est\u00e1 dispon\u00edvel na p\u00e1gina {a_start} Pedidos e assinaturas {a_end}",
    ...
    "Section {currentPage} of {totalPages}": "Se\u00e7\u00e3o {currentPage} de {totalPages}",
    "Sections": "Se\u00e7\u00f5es",
    ...
    "Showing first response": [
      ...
      "Mostrando as primeiras respostas {numResponses}",
      "Mostrando as primeiras respostas {numResponses}"
    ],
    ...
    "Start {trialLength}-day free trial": "Inicie o teste gratuito de {trialLength} dias",
    ...
    "Subscription trial expires in {remainingDays} day": [
      "A avalia\u00e7\u00e3o da assinatura expira no dia {remainingDays}",
      "A avalia\u00e7\u00e3o da assinatura expira em {remainingDays} dias",
      "A avalia\u00e7\u00e3o da assinatura expira em {remainingDays} dias"
    ],
    "Subsection": "Subse\u00e7\u00e3o",
    ...
    "There was an error when trying to add learners:": [
      ...
      "Os alunos {numErrors} n\u00e3o puderam ser adicionados a este coorte:",
      "Os alunos {numErrors} n\u00e3o puderam ser adicionados a este coorte:"
    ],
    ...
    "Track and plan your progress through the %(count)s course(s) in this program. To complete the program, you must earn a verified certificate for each course.": "faixa e planeje seu progresso atrav\u00e9s do(s) curso(s) %(count)s deste programa. Para concluir o programa, voc\u00ea deve obter um Certificado verificado para cada curso.",
    "Track and plan your progress through the %(count)s courses in this program. To complete the program, you must earn a verified certificate for each course.": "faixa e planeje seu progresso atrav\u00e9s dos cursos %(count)s deste programa. Para concluir o programa, voc\u00ea deve obter um Certificado verificado para cada curso.",
    ...
    "Trial ends {trialEndDate} at {trialEndTime}": "O teste termina {trialEndDate} em {trialEndTime}",
    ...
    "Upgrade with a subscription": "atualizar com uma assinatura",
    "Upload": "Enviar",
    ...
    "Used in {count} location": [
      "Usado no local {count}",
      "Usado em locais {count}",
      "Usado em locais {count}"
    ],
    ...
    "View your receipts or modify your subscription on the {a_start}Orders and subscriptions{a_end} page": "Veja seus recibos ou modifique sua assinatura na p\u00e1gina {a_start} Pedidos e assinaturas {a_end}",
    "View {span_start} {team_name} {span_end}": "Visualizar {span_start} {team_name} {span_end}",
    "Viewing %s course": [
      "Visualizando o curso %s",
      "Visualizando cursos %s",
      "Visualizando cursos %s"
    ],
    ...
    "What if I have difficulty holding my ID in position relative to the camera?": "E se eu tiver dificuldade em manter minha identifica\u00e7\u00e3o na posi\u00e7\u00e3o relativa \u00e0 c\u00e2mera?",
    ...
    "When sharing this link with your learners, they will see the content of the subsection along with the header and footer of your LMS.": "Ao compartilhar este link com seus alunos, eles ver\u00e3o o conte\u00fado da subse\u00e7\u00e3o junto com o cabe\u00e7alho e rodap\u00e9 do seu LMS.",
    ...
    "You have successfully completed all the requirements for the %(title)s %(type)s.": "Voc\u00ea completado com sucesso todos os requisitos para o %(title)s %(type)s .",
    ...
    "Your next billing date is {currentPeriodEnd}": "Sua pr\u00f3xima data de faturamento \u00e9 {currentPeriodEnd}",
    ...
    "Your {programName} trial will expire in {remainingDays} day at {trialEndTime} on {trialEndDate} and the card on file will be charged {subscriptionPrice}.": [
      "Sua avalia\u00e7\u00e3o {programName} expirar\u00e1 no dia {remainingDays} em {trialEndTime} em {trialEndDate} e o cart\u00e3o registrado ser\u00e1 cobrado {subscriptionPrice} .",
      "Sua avalia\u00e7\u00e3o {programName} expirar\u00e1 em {remainingDays} dias em {trialEndTime} em {trialEndDate} e o cart\u00e3o registrado ser\u00e1 cobrado {subscriptionPrice} .",
      "Sua avalia\u00e7\u00e3o {programName} expirar\u00e1 em {remainingDays} dias em {trialEndTime} em {trialEndDate} e o cart\u00e3o registrado ser\u00e1 cobrado {subscriptionPrice} ."
    ],
    ...
    "there is currently {numVotes} vote": [
      "atualmente h\u00e1 voto {numVotes}",
      "atualmente h\u00e1 votos {numVotes}",
      "atualmente h\u00e1 votos {numVotes}"
    ],
    ...
    "{numMoved} learner was moved from {prevCohort}": [
      "O aluno {numMoved} foi movido de {prevCohort}",
      "Os alunos {numMoved} foram movidos de {prevCohort}",
      "Os alunos {numMoved} foram movidos de {prevCohort}"
    ],
    "{numPreassigned} learner was pre-assigned for this cohort. This learner will automatically be added to the cohort when they enroll in the course.": [
      "O aluno {numPreassigned} foi pr\u00e9-atribu\u00eddo para este grupo. Este aluno ser\u00e1 automaticamente adicionado ao grupo quando se inscrever no curso.",
      "Os alunos {numPreassigned} foram pr\u00e9-designados para este grupo. Esses alunos ser\u00e3o adicionados automaticamente ao grupo quando se inscreverem no curso.",
      "Os alunos {numPreassigned} foram pr\u00e9-designados para este grupo. Esses alunos ser\u00e3o adicionados automaticamente ao grupo quando se inscreverem no curso."
    ],
    "{numPresent} learner was already in the cohort": [
      "O aluno {numPresent} j\u00e1 estava na coorte",
      "Os alunos {numPresent} j\u00e1 estavam na coorte",
      "Os alunos {numPresent} j\u00e1 estavam na coorte"
    ],
    ...
    "{numResponses} response": [
      "resposta {numResponses}",
      "respostas {numResponses}",
      "respostas {numResponses}"
    ],
    "{numUsersAdded} learner has been added to this cohort. ": [
      "O aluno {numUsersAdded} foi adicionado a este grupo. ",
      "Os alunos {numUsersAdded} foram adicionados a este grupo. ",
      "Os alunos {numUsersAdded} foram adicionados a este grupo. "
    ],
    "{numVotes} Vote": [
      "{numVotes} Votar",
    ...
    "{num_points} point possible (ungraded)": [
      "{num_points} ponto poss\u00edvel (sem classifica\u00e7\u00e3o)",
    ...
    "{subscriptionPrice} subscription after trial ends. Cancel anytime.": "Assinatura {subscriptionPrice} ap\u00f3s o t\u00e9rmino da avalia\u00e7\u00e3o. cancelar a qualquer momento.",
    "{subscriptionPrice} subscription. Cancel anytime.": "Assinatura {subscriptionPrice} . cancelar a qualquer momento.",
    "{team_count} Team": [
      "Equipe {team_count}",
      "{team_count} Equipes",
      "{team_count} Equipes"
