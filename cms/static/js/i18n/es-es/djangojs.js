...
'use strict';
{
  ...
  const newcatalog = {
    ...
    "Embed your subsection content directly on a page using an iframe, and view it withput the LMS header and footer.": "Incruste el contenido de su subsecci\u00f3n directamente en una p\u00e1gina usando un iframe y visual\u00edcelo sin el encabezado y pie de p\u00e1gina del LMS.",
    ...
    "Section {currentPage} of {totalPages}": "Secci\u00f3n {currentPage} de {totalPages}",
    "Sections": "Secciones",
    ...
    "Subscription trial expires in {remainingDays} day": [
      "La prueba de suscripci\u00f3n vence el d\u00eda {remainingDays}",
    ...
    "Welcome to edX! Before you get started, please take a few minutes to fill-in the additional information below to help us understand a bit more about your background. You can always edit this information later in Account Settings.": "\u00a1Bienvenido a edX! Antes de comenzar, t\u00f3mate unos minutos para completar la informaci\u00f3n adicional a continuaci\u00f3n para ayudarnos a comprender un poco m\u00e1s sobre tus antecedentes. Siempre podr\u00e1s editar esta informaci\u00f3n m\u00e1s adelante en Configuraci\u00f3n de la cuenta.",
    ...
    "You may also lose access to verified certificates and other program credentials. You can make a copy of these for your records before proceeding with deletion.": "Es posible que peirdas el acceso a certificados verificados y a otras credenciales del programa. Puedes hacer una copia de estos registros antes de proceder con la eliminaci\u00f3n.",
    ...
    "Your {programName} trial will expire in {remainingDays} day at {trialEndTime} on {trialEndDate} and the card on file will be charged {subscriptionPrice}.": [
      "Su prueba {programName} caducar\u00e1 el d\u00eda {remainingDays} en {trialEndTime} en {trialEndDate} y se cargar\u00e1 a la tarjeta registrada {subscriptionPrice} .",
      "Su prueba {programName} caducar\u00e1 en {remainingDays} d\u00edas en {trialEndTime} en {trialEndDate} y se cargar\u00e1 a la tarjeta registrada {subscriptionPrice} .",
      "Su prueba {programName} caducar\u00e1 en {remainingDays} d\u00edas en {trialEndTime} en {trialEndDate} y se cargar\u00e1 a la tarjeta registrada {subscriptionPrice} ."
    ],
