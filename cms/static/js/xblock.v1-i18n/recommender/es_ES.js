...
'use strict';
{
  ...
  const newcatalog = {
    ...
    "Upload a preview screenshot (in GIF/PNG/JPG) of the resource; ideally, this should let students know whether this resources is useful to them": "Cargue una captura de pantalla de vista previa (en GIF/PNG/JPG) del recurso; Idealmente, esto deber\u00eda permitirles a los estudiantes saber si este recurso es \u00fatil para ellos.",
