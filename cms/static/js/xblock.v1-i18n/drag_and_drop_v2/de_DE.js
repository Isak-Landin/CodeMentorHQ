...
'use strict';
{
  ...
  const newcatalog = {
    ...
    "(inherited from Advanced Settings)": "(geerbt aus den erweiterten Einstellungen)",
    ", draggable": ", ziehbar",
    ...
    "After All Attempts": "Nach allen Versuchen",
    "After All Attempts or Correct": "\u00a0\n\u00a0\nNach allen Versuchen oder richtig",
    "Always": "Immer",
    ...
    "Continue": "Fortsetzen",
    "Correct": "Korrekt",
    "Correct or Past Due": "Korrekt oder \u00dcberf\u00e4llig",
    ...
    "Correctly placed {correct_count} item": [
      "Korrekt platzierter {correct_count} Artikel",
      "Korrekt platzierte {correct_count} Elemente"
    ],
    ...
    "Defines when to show the answer to the problem. A default value can be set in Advanced Settings. To revert setting a custom value, choose the 'Default' option.": "Definiert, wann die Antwort auf das Problem angezeigt werden soll. In den erweiterten Einstellungen kann ein Standardwert festgelegt werden. Um die Einstellung eines benutzerdefinierten Werts r\u00fcckg\u00e4ngig zu machen, w\u00e4hlen Sie die Option \u201eStandard\u201c.",
    "Did not place {missing_count} required item": [
      "Der {missing_count} erforderliche Artikel wurde nicht platziert",
      "Die {missing_count} erforderlichen Artikel wurden nicht platziert"
    ],
    ...
    "Display zone borders when dragging an item": "Beim Ziehen eines Elements Zonengrenzen anzeigen",
    ...
    "Explanation Text": "Erl\u00e4uterungstext",
    ...
    "Information about zones, items, feedback, explanation and background image for this problem. This information is derived from the input that a course author provides via the interactive editor when configuring the problem.": "Informationen zu Zonen, Elementen, Feedback, Erkl\u00e4rung und Hintergrundbild f\u00fcr dieses Problem. Diese Informationen werden aus den Eingaben abgeleitet, die ein Kursautor beim Konfigurieren des Problems \u00fcber den interaktiven Editor bereitstellt.",
    ...
    "Maximum score available of the problem as a raw value between 0 and 1.": "Maximal verf\u00fcgbare Punktzahl des Problems als Rohwert zwischen 0 und 1.",
    "Misplaced {misplaced_count} item": [
      "{misplaced_count} Artikel verlegt",
      "Fehlplatzierte {misplaced_count} Artikel"
    ],
    "Misplaced {misplaced_count} item (misplaced item was returned to the item bank)": [
      "Falsch platzierter {misplaced_count} Artikel (der verlegte Artikel wurde an die Artikelbank zur\u00fcckgegeben)",
      "Verlegte {misplaced_count} Artikel (verlegte Artikel wurden an die Artikelbank zur\u00fcckgegeben)"
    ],
    "Mode": "Modus",
    ...
    "The answer is unavailable": "Die Antwort ist nicht verf\u00fcgbar",
