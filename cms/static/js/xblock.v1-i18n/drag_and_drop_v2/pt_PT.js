...
'use strict';
{
  ...
  const newcatalog = {
    ...
    "After All Attempts": "Depois de todas as tentativas",
    "After All Attempts or Correct": "Depois de todas as tentativas ou correto",
    "Always": "Sempre",
    ...
    "Attempted": "Tentativa",
    "Attempted or Past Due": "Tentativa ou Vencido",
    ...
    "Continue": "Continuar",
    "Correct": "Correto",
    "Correct or Past Due": "Correto ou Prazo Vencido",
    ...
    "Correctly placed {correct_count} item": [
      "Colocou corretamente {correct_count} item",
      "Colocou corretamente {correct_count} itens",
      "Colocou corretamente {correct_count} itens"
    ],
    ...
    "Defines when to show the answer to the problem. A default value can be set in Advanced Settings. To revert setting a custom value, choose the 'Default' option.": "Define quando mostrar a resposta para o problema. Um valor por defeito pode ser definido em Defini\u00e7\u00f5es Avan\u00e7adas. Para reverter a defini\u00e7\u00e3o de um valor personalizado, escolha a op\u00e7\u00e3o 'Predefini\u00e7\u00e3o'.",
    "Did not place {missing_count} required item": [
      "N\u00e3o colocou {missing_count} item obrigat\u00f3rio",
      "N\u00e3o colocou {missing_count} itens obrigat\u00f3rios",
      "N\u00e3o colocou {missing_count} itens obrigat\u00f3rios"
    ],
    ...
    "Display zone borders when dragging an item": "Margens da zona de exposi\u00e7\u00e3o ao arrastar um item",
    ...
    "Explanation Text": "Explica\u00e7\u00e3o do texto",
    "Feedback": "Coment\u00e1rio",
    ...
    "Information about zones, items, feedback, explanation and background image for this problem. This information is derived from the input that a course author provides via the interactive editor when configuring the problem.": "Informa\u00e7\u00e3o sobre zonas, itens, feedback, explica\u00e7\u00e3o e imagem de fundo para este problema. Esta informa\u00e7\u00e3o deriva da entrada que um autor do curso fornece atrav\u00e9s do editor interactivo ao configurar o problema.",
    ...
    "Misplaced {misplaced_count} item": [
      "Colocou incorretamente {misplaced_count} item",
      "Colocou incorretamente {misplaced_count} itens",
      "Colocou incorretamente {misplaced_count} itens"
    ],
    "Misplaced {misplaced_count} item (misplaced item was returned to the item bank)": [
      "Colocou incorretamente {misplaced_count} item (foi devolvido ao banco de itens)",
      "Colocou incorretamente {misplaced_count} itens (foram devolvidos ao banco de itens)",
      "Colocou incorretamente {misplaced_count} itens (foram devolvidos ao banco de itens)"
    ],
    "Mode": "Modo",
    ...
    "{possible} point possible (graded)": [
      ...
      "{possible} pontos poss\u00edveis (classificados)",
      "{possible} pontos poss\u00edveis (classificados)"
    ],
    "{possible} point possible (ungraded)": [
      "{possible} ponto poss\u00edvel (n\u00e3o classificado)",
      "{possible} pontos poss\u00edveis (n\u00e3o classificados)",
      "{possible} pontos poss\u00edveis (n\u00e3o classificados)"
    ]
  };
