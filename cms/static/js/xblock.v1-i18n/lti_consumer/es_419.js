...
'use strict';
{
  ...
  const newcatalog = {
    "Accept grades past deadline": "Fecha limite para aceptar notas",
    ...
    "Enter the number of points possible for this component.  The default value is 1.0.  This setting is only used when Scored is set to True.": "Ingrese en n\u00famero de puntos posibles para este componente. El valor por defecto es 1.0. Este valor solo se utiliza cuando el par\u00e1metro de calificaci\u00f3n est\u00e1 definido como VERDADERO",
    ...
    "Press to Launch": "Haz clic para lanzar",
    "Registered Redirect URIs": "URI de redireccionamiento registrados",
    "Request user's email": "Solicite la direcci\u00f3n de correo del usuario",
    "Request user's full name": "Solicitar el nombre completo del usuario",
    "Request user's username": "Solicite el nombre del usuario",
    ...
    "Select True if this component will receive a numerical score from the external LTI system.": "Seleccione VERDADERO si este componente recibir\u00e1 una puntuaci\u00f3n num\u00e9rica desde un sistema LTI externo.",
