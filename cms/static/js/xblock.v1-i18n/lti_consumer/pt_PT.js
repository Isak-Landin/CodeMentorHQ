...
'use strict';
{
  ...
  const newcatalog = {
    ...
    "Click OK to have your full name and e-mail address sent to a 3rd party application.": "Clique em OK para que o seu nome completo e endere\u00e7o de e-mail sejam enviados para uma aplica\u00e7\u00e3o de terceiros.",
    "Click OK to have your full name sent to a 3rd party application.": "Clique em OK para que o seu nome completo seja enviado para uma aplica\u00e7\u00e3o de terceiros.",
    ...
    "Click OK to have your username and full name sent to a 3rd party application.": "Clique em OK para que o seu nome de utilizador e nome completo sejam enviados para uma aplica\u00e7\u00e3o de terceiros.",
    ...
    "Click OK to have your username, full name, and e-mail address sent to a 3rd party application.": "Clique em OK para que o seu nome de utilizador, nome completo e endere\u00e7o de e-mail sejam enviados para uma aplica\u00e7\u00e3o de terceiros.",
    ...
    "Custom Parameters should be strings in \"x=y\" format.": "Os par\u00e2metros personalizados devem ser cadeias de caracteres no formato \"x=y\".",
    ...
    "LTI Configuration using reusable configuration needs a external ID in \"x:y\" format.": "A Configura\u00e7\u00e3o LTI que utiliza a configura\u00e7\u00e3o reutiliz\u00e1vel necessita de uma identifica\u00e7\u00e3o externa no formato \"x:y\".",
    ...
    "Request user's full name": "Pedir o nome completo do utilizador",
    "Request user's username": "Solicitar o nome do utilizador",
    "Return to exam.": "Regressar ao exame.",
    "Reusable Configuration": "Configura\u00e7\u00e3o reutiliz\u00e1vel",
    "Reusable configuration ID must be set when using external config (Example: \"x:y\").": "A ID de configura\u00e7\u00e3o reutiliz\u00e1vel deve ser definida quando se utiliza a configura\u00e7\u00e3o externa (Exemplo: \"x:y\").",
    "Scored": "Pontua\u00e7\u00e3o",
    ...
    "Select True to request the user's full name.": "Selecione \"Verdadeiro\" para pedir o nome completo do utilizador.",
    ...
    "Sending you back to your exam.": "A reencaminh\u00e1-lo de volta para o seu exame.",
    ...
    "The specified LTI ID is not configured in this course's Advanced Settings.": "O ID LTI indicado n\u00e3o est\u00e1 configurado nas Defini\u00e7\u00f5es Avan\u00e7adas deste curso.",
    "There was an error while launching the LTI tool: ": "Ocorreu um erro no lan\u00e7amento da ferramenta LTI:",
