...
'use strict';
{
  ...
  const newcatalog = {
    ...
    "%(errorCount)s error found in form.": [
      "Errore %(errorCount)s trovato nel modulo.",
    ...
    "(contains %(student_count)s student)": [
      "(contiene lo studente %(student_count)s )",
      "(contiene studenti %(student_count)s )",
      "(contiene studenti %(student_count)s )"
    ],
    "(optional)": "(facoltativo)",
    ...
    "Click to copy link to clipboard": "Fare clic per copiare il collegamento negli appunti",
    ...
    "Embed your subsection content directly on a page using an iframe, and view it withput the LMS header and footer.": "Incorpora il contenuto della tua sottosezione direttamente in una pagina utilizzando un iframe e visualizzalo inserendo l&#39;intestazione e il pi\u00e8 di pagina LMS.",
    "Emoticons": "Emoticon",
    "Enable": "Abilita",
    ...
    "If you make this section visible in the table of content, learners will be able to see its content.": "Se rendi questa sezione visibile nel sommario, gli studenti potranno vederne il contenuto.",
    ...
    "It is intentionally hidden from standard navigation, ensuring that only individuals with the link can view its contents.": "\u00c8 intenzionalmente nascosto dalla navigazione standard, garantendo che solo le persone con il collegamento possano visualizzarne i contenuti.",
    ...
    "It is visible to learners, ensuring that all learners can view its contents.": "\u00c8 visibile agli studenti, garantendo che tutti gli studenti possano visualizzarne i contenuti.",
    "Italic": "Corsivo",
    ...
    "Load next {num_items} result": [
      "Carica il risultato {num_items} successivo",
      "Carica i risultati {num_items} successivi",
      "Carica i risultati {num_items} successivi"
    ],
    "Loading": "Caricamento",
    ...
    "Please enable discussions for graded units from the": "Si prega di abilitare le discussioni per le unit\u00e0 classificate da",
    ...
    "Showing first response": [
      ...
      "Visualizzazione delle prime risposte {numResponses}",
      "Visualizzazione delle prime risposte {numResponses}"
    ],
    ...
    "Subscription trial expires in {remainingDays} day": [
      "La prova dell&#39;abbonamento scade tra {remainingDays} giorno",
      "La prova dell&#39;abbonamento scade tra {remainingDays} giorni",
      "La prova dell&#39;abbonamento scade tra {remainingDays} giorni"
    ],
    ...
    "Subsections are not navigable between each other, they can only be accessed through their link.": "Le sottosezioni non sono navigabili tra loro, \u00e8 possibile accedervi solo tramite il relativo link.",
    "Success": "Successo",
    ...
    "There was an error when trying to add learners:": [
      ...
      "Impossibile aggiungere gli studenti {numErrors} a questa coorte:",
      "Impossibile aggiungere gli studenti {numErrors} a questa coorte:"
    ],
    ...
    "To hide the subsections and keep them accesible through links, you must adjust it from the section that contains them.": "Per nascondere le sottosezioni e mantenerle accessibili tramite link \u00e8 necessario regolarlo dalla sezione che le contiene.",
    ...
    "Used in {count} location": [
      "Utilizzato nella posizione {count}",
      "Utilizzato nelle posizioni {count}",
      "Utilizzato nelle posizioni {count}"
    ],
    ...
    "Your {programName} trial will expire in {remainingDays} day at {trialEndTime} on {trialEndDate} and the card on file will be charged {subscriptionPrice}.": [
      "La tua prova {programName} scadr\u00e0 tra {remainingDays} giorno alle {trialEndTime} su {trialEndDate} e la carta in archivio verr\u00e0 addebitata {subscriptionPrice} .",
      "La tua prova {programName} scadr\u00e0 tra {remainingDays} giorni alle {trialEndTime} su {trialEndDate} e la carta in archivio verr\u00e0 addebitata {subscriptionPrice} .",
      "La tua prova {programName} scadr\u00e0 tra {remainingDays} giorni alle {trialEndTime} su {trialEndDate} e la carta in archivio verr\u00e0 addebitata {subscriptionPrice} ."
    ],
    ...
    "there is currently {numVotes} vote": [
      "attualmente c&#39;\u00e8 il voto {numVotes}",
      "attualmente ci sono voti {numVotes}",
      "attualmente ci sono voti {numVotes}"
    ],
    ...
    "{numPreassigned} learner was pre-assigned for this cohort. This learner will automatically be added to the cohort when they enroll in the course.": [
      ...
      "gli studenti {numPreassigned} sono stati preassegnati per questo gruppo. Questi studenti verranno automaticamente aggiunti al gruppo quando si iscriveranno al corso.",
      "gli studenti {numPreassigned} sono stati preassegnati per questo gruppo. Questi studenti verranno automaticamente aggiunti al gruppo quando si iscriveranno al corso."
    ],
    "{numPresent} learner was already in the cohort": [
      "{numPresent} lo studente era gi\u00e0 nel gruppo",
      "{numPresent} gli studenti erano gi\u00e0 nel gruppo",
      "{numPresent} gli studenti erano gi\u00e0 nel gruppo"
    ],
    ...
    "{numResponses} response": [
      "risposta {numResponses}",
      "{numResponses} risposte",
      "{numResponses} risposte"
    ],
    "{numUsersAdded} learner has been added to this cohort. ": [
      "Lo studente {numUsersAdded} \u00e8 stato aggiunto a questo gruppo. ",
      "Gli studenti {numUsersAdded} sono stati aggiunti a questo gruppo. ",
      "Gli studenti {numUsersAdded} sono stati aggiunti a questo gruppo. "
    ],
    "{numVotes} Vote": [
      "{numVotes} Vota",
    ...
    "{num_points} point possible (graded)": [
      "{num_points} punti possibili (classificati)",
      "{num_points} punti possibili (classificati)",
      "{num_points} punti possibili (classificati)"
    ],
    "{num_points} point possible (graded, results hidden)": [
      "{num_points} punti possibili (classificati, risultati nascosti)",
      "{num_points} punti possibili (valutati, risultati nascosti)",
      "{num_points} punti possibili (valutati, risultati nascosti)"
    ],
    "{num_points} point possible (ungraded)": [
      "{num_points} punti possibili (non classificati)",
      "{num_points} punti possibili (senza valutazione)",
      "{num_points} punti possibili (senza valutazione)"
    ],
    "{num_points} point possible (ungraded, results hidden)": [
      "{num_points} punti possibili (non classificato, risultati nascosti)",
      "{num_points} punti possibili (senza voto, risultati nascosti)",
      "{num_points} punti possibili (senza voto, risultati nascosti)"
    ],
    ...
    "{total_results} result found for \"{search_term}\"": [
      "{total_results} trovato risultato per &quot; {search_term} &quot;",
