...
'use strict';
{
  ...
  const newcatalog = {
    ...
    "Embed your subsection content directly on a page using an iframe, and view it withput the LMS header and footer.": "Betten Sie den Inhalt Ihres Unterabschnitts mithilfe eines Iframes direkt auf einer Seite ein und zeigen Sie ihn ohne LMS-Kopf- und -Fu\u00dfzeile an.",
    "Emoticons": "Emoticons",
    "Enable": "aktivieren",
    ...
    "Section {currentPage} of {totalPages}": "Abschnitt {currentPage} von {totalPages}",
    "Sections": "Abschnitte",
    ...
    "Subscription trial expires in {remainingDays} day": [
      "Die Testversion des Abonnements l\u00e4uft am {remainingDays} Tag ab",
      "Die Testversion des Abonnements l\u00e4uft in {remainingDays} Tagen ab"
    ],
    ...
    "Welcome to edX! Before you get started, please take a few minutes to fill-in the additional information below to help us understand a bit more about your background. You can always edit this information later in Account Settings.": "Willkommen bei edX! Bevor Sie beginnen, nehmen Sie sich bitte ein paar Minuten Zeit, um die folgenden zus\u00e4tzlichen Informationen auszuf\u00fcllen, damit wir etwas mehr \u00fcber Ihren Hintergrund erfahren. Sie k\u00f6nnen diese Informationen sp\u00e4ter jederzeit in den Kontoeinstellungen bearbeiten.",
    ...
    "Your {programName} trial will expire in {remainingDays} day at {trialEndTime} on {trialEndDate} and the card on file will be charged {subscriptionPrice}.": [
      "Ihre {programName} -Testversion l\u00e4uft am {remainingDays} Tag um {trialEndTime} am {trialEndDate} ab und die hinterlegte Karte wird {subscriptionPrice} belastet.",
      "Ihre {programName} Testversion l\u00e4uft in {remainingDays} Tagen bei {trialEndTime} am {trialEndDate} ab und die hinterlegte Karte wird {subscriptionPrice} belastet."
    ],
