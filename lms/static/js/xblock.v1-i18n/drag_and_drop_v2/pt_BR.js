...
'use strict';
{
  ...
  const newcatalog = {
    ...
    "(inherited from Advanced Settings)": "(herdado de Configura\u00e7\u00f5es Avan\u00e7adas)",
    ...
    "After All Attempts": "Ap\u00f3s todas as tentativas",
    "After All Attempts or Correct": "Depois de todas as tentativas ou corrigir",
    "Always": "Sempre",
    ...
    "Attempted": "Ap\u00f3s tentativa",
    "Attempted or Past Due": "Tentativa ou Vencida",
    ...
    "Continue": "Continuar",
    "Correct": "Correto",
    "Correct or Past Due": "Correto ou Atrasado",
    ...
    "Correctly placed {correct_count} item": [
      "Item {correct_count} colocado corretamente",
      "Itens {correct_count} colocados corretamente",
      "Itens {correct_count} colocados corretamente"
    ],
    ...
    "Defines when to show the answer to the problem. A default value can be set in Advanced Settings. To revert setting a custom value, choose the 'Default' option.": "Define quando mostrar a resposta para o problema. Um valor padr\u00e3o pode ser definido em Configura\u00e7\u00f5es avan\u00e7adas. Para reverter a configura\u00e7\u00e3o de um valor personalizado, escolha a op\u00e7\u00e3o \u2018Padr\u00e3o\u2019.",
    "Did not place {missing_count} required item": [
      "N\u00e3o foi colocado o item obrigat\u00f3rio {missing_count}",
      "N\u00e3o colocou itens obrigat\u00f3rios {missing_count}",
      "N\u00e3o colocou itens obrigat\u00f3rios {missing_count}"
    ],
    ...
    "Display zone borders when dragging an item": "Exibir bordas da zona ao arrastar um item",
    ...
    "Maximum score available of the problem as a raw value between 0 and 1.": "Pontua\u00e7\u00e3o m\u00e1xima dispon\u00edvel do problema como um valor bruto entre 0 e 1.",
    "Misplaced {misplaced_count} item": [
      "Item {misplaced_count} extraviado",
      "Itens {misplaced_count} perdidos",
      "Itens {misplaced_count} perdidos"
    ],
    "Misplaced {misplaced_count} item (misplaced item was returned to the item bank)": [
      "Item {misplaced_count} extraviado (o item extraviado foi devolvido ao banco de itens)",
      "Itens {misplaced_count} extraviados (os itens extraviados foram devolvidos ao banco de itens)",
      "Itens {misplaced_count} extraviados (os itens extraviados foram devolvidos ao banco de itens)"
    ],
    "Mode": "Modo",
    ...
    "The answer is unavailable": "A resposta n\u00e3o est\u00e1 dispon\u00edvel",
    ...
    "{earned}/{possible} point (graded)": [
      "ponto {earned} / {possible} (classificado)",
      "pontos {earned} / {possible} (classificado)",
      "pontos {earned} / {possible} (classificado)"
    ],
    "{earned}/{possible} point (ungraded)": [
      "ponto {earned} / {possible} (sem classifica\u00e7\u00e3o)",
      "pontos {earned} / {possible} (sem classifica\u00e7\u00e3o)",
      "pontos {earned} / {possible} (sem classifica\u00e7\u00e3o)"
    ],
    ...
    "{possible} point possible (ungraded)": [
      "{possible} ponto poss\u00edvel (sem classifica\u00e7\u00e3o)",
      "{possible} pontos poss\u00edveis (sem classifica\u00e7\u00e3o)",
      "{possible} pontos poss\u00edveis (sem classifica\u00e7\u00e3o)"
    ]
  };
